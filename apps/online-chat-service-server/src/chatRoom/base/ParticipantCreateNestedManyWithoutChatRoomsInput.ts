...
@InputType()
class ParticipantCreateNestedManyWithoutChatRoomsInput {
...
export { ParticipantCreateNestedManyWithoutChatRoomsInput as ParticipantCreateNestedManyWithoutChatRoomsInput };
